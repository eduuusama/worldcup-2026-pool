...
const MESSAGES: Record<Lang, Dict> = {
  es: {
    ...
    bracket_points_title: "Puntos por acierto",
    ...
    ko_who_picked: "¿Quién eligió a quién?",
    max_score: "Máx",
    max_score_hint: "Máximo posible — según cuántos de sus equipos siguen vivos en el cuadro",
  ...
  en: {
    ...
    bracket_points_title: "Points per correct pick",
    ...
    ko_who_picked: "Who picked whom?",
    max_score: "Max",
    max_score_hint: "Highest still reachable — based on how many of their teams are still alive in the bracket",
